...
This version of **hmm** evolves from a simple *question journal* into an *ecosystem of curiosity* — powered by embeddings, context, and reflection rather than manual organization.
...
**hmm** is a minimal interface for *asking, storing, and exploring questions*.
...
Users interact through *a single, quiet, expressive interface*.
Behind that simplicity lives a *semantic substrate* — a vector database that holds all questions in a high-dimensional curiosity space.
...
* Users can recall past questions *semantically*, not by keyword.
...
* No tags or folders — instead, “neighborhoods” of meaning:
  ...
  * *Curiosity clusters* (e.g., “selfhood,” “creativity,” “uncertainty”).
...
* Organization happens *after the fact*, invisibly.
...
* hmm might gently *ask back*:

  * “Would you like to explore this theme?”
  * “Want to see how you’ve changed your mind about X?”
* Could even generate *“curiosity prompts”* from your own question corpus.
...
> System starts engaging *with* questions.
...
* Generate *answers from multiple voices* (Socratic, poetic, scientific).
* Cluster answers just like questions — *answers are questions in disguise*.
...
> The system *understands* relationships between thoughts.

This is the difference between hmm and every other note-taking or journaling app.
It’s not a filing cabinet. It’s a *field of meaning.*
...
*(Pseudocode; adjust to Convex’s exact APIs in your project.)*
...
* Don’t persist clusters. For discovery views, show *“Nearby Questions”* and *“Ad-hoc Neighborhoods”* using vector search from the current question or query embedding.
...
* Provide user switchers: *Themes • Recents • Changing-your-mind*.
...
* *Input:* user question.
* *Output:* 1–2 short prompts, ≤200 chars each.
* *Guardrails:* never answer, never judge.
